...
newtype FeedAlternateList = FeedAlternateList
    { alternateList :: [FeedAlternate]
    } deriving (Generic,Show)

instance ToJSON FeedAlternate
instance FromJSON FeedAlternate where
    parseJSON =
        withObject "Feed Alternate" $
        \o ->
             FeedAlternate <$> o .: "href" <*> o .: "type"
...
instance FromJSON FeedOrigin where
    parseJSON =
        withObject "Feed Origin" $
        \o ->
             FeedOrigin <$> o .: "streamId" <*> o .: "title" <*> o .: "htmlUrl"
...
instance FromJSON FeedSummary where
    parseJSON =
        withObject "Feed Summary" $
        \o ->
             FeedSummary <$> o .: "content" <*> o .: "direction"
...
instance FromJSON FeedCategory where
    parseJSON =
        withObject "Feed Category" $
        \o ->
             FeedCategory <$> o .: "id" <*> o .: "label"

newtype FeedCategoryList = FeedCategoryList
...
instance FromJSON FeedItem where
    parseJSON =
        withObject "Feed Item" $
        \o ->
             FeedItem <$> o .: "id" <*> o .: "originId" <*> o .: "fingerprint" <*>
             o .: "title" <*>
             (posixSecondsToUTCTime . (/ 1000) . fromInteger <$>
              o .: "published") <*>
